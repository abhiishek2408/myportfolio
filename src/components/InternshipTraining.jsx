        ...
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <div className="w-full lg:w-1/2 pl-12 lg:pl-0">
              <div className="p-8 md:p-10 bg-slate-100 dark:bg-white/5 bglass-dark rounded-[2.5rem] border border-slate-500/40 dark:border-white/30 hover:border-purple-500/30 transition-all duration-500 group relative overflow-hidden shadow-none">
